...
For example, all test cases on CCC 2015 S3 - [Gates](https://dmoj.ca/problem/ccc15s3) can be solved with a brute force O(N^2) solution
in the official contest portal. However, an O(N logN) solution is required to pass all DMOJ tests without TLE.
